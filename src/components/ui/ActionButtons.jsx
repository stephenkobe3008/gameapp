...
import { Building2, Users, BookOpen, Home } from 'lucide-react';

export const ActionButtons = ({ onBuild, onMissionary, onResearch, onHome }) => {
  return (
    <div className="bg-amber-900 p-2 grid grid-cols-4 gap-2">
      <button
        onClick={onBuild}
      ...
      >
        <Home size={24} />
        <span className="text-xs font-bold">タイトル</span>
      </button>
    </div>
  );
};
